...
const restaurant = {
  ...
  //ES6 object literals
  openingHours, // basically "openingHours"-object is restored

  order(starterIndex, mainIndex) {
    return [this.starterMenu[starterIndex], this.mainMenu[mainIndex]]; // We delete function "order function(starterIndex, mainIndex)", ES6 apply that
  },
...
// ES6 new three ways for introduce array:
